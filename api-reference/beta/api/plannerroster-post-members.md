...
In addition to [general errors](../resources/graph/errors) that apply to Microsoft Graph and the error cases documented in [planner overview](../resources/planner-overview.md), some error conditions are specific to the API to add a member to the [plannerRoster](../resources/plannerrostermember.md) object.
